...
export function Navbar() {
  ...
  const navItems = [
    { path: '/', label: 'Home' },
    { path: '/crop-recommendation', label: 'Crop Guide' },
    { path: '/yield-prediction', label: 'Yield' },
    { path: '/fertilizer-guide', label: 'Fertilizer' },
    { path: '/disease-detection', label: 'Diseases' },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          <Link to="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-slate-800 dark:text-white">Fasal</span>
          </Link>
